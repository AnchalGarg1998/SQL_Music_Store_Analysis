...
/*Question 3- What are the top 3 values of total invoice?*/
select total from invoice
order by total desc
limit 3;

/*Question 4- Which city has the best customers? We would like to throw a promotional Music Festival in the city we made
...
/* Question 9: We want to find out the most popular music Genre for each country. We determine the most popular genre as the genre 
...
WITH Customter_with_country AS ( SELECT customer.customer_id,first_name,last_name,billing_country,SUM(total) AS total_spending,
